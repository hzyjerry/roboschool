...
class RoboschoolReacherLine(RoboschoolMujocoXmlEnv):
    def __init__(self):
    ...
    def robot_specific_reset(self):
        fix_target_x = 0.16
        self.jdict["target_x"].reset_current_position(fix_target_x, 0)
    ...
    def _step(self, a):
        ...
        self.frame  += 1
        done = np.linalg.norm(self.to_target_vec) < 0.015
